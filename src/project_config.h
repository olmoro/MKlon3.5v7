...
namespace MPrj
{
  ...
  static constexpr short smooth_v_default = 4u;
  static constexpr short smooth_i_default = 4u;
  ...
  static constexpr float ki_i_default = 1.80f;   //1.79f;
  static constexpr float kd_i_default = 0.01f;   //0.09f;
